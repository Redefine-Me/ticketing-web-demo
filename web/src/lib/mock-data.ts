import type { University, Society, Category, EventWithDetails, UserProfile, Location, ScheduleEntry } from '../types';
import { mockEvents as dashboardEvents } from '../../../src/lib/mock-data';

// ── Universities (web-specific schema) ───────────────────────
...
// ── Categories (web-specific with UUIDs and slugs) ───────────
