    ...
    messages: [
      {
        ...
        sender: "you",
        senderName: "You",
        message: "Hi, we'd like to book your function room for a Simpsons trivia night on November 14, from 7:30pm. Expecting about 50-60 people.",
        sentAt: "2025-10-25T14:00:00Z",
      },
      {
        id: "m-007",
        sender: "venue",
        senderName: "256 Wilmslow Road",
        message: "Hey! We can do the function room for you. 7:30pm works. Do you want a tab or individual payments?",
        sentAt: "2025-10-26T09:30:00Z",
      },
      {
        id: "m-008",
        sender: "you",
        senderName: "You",
        message: "Individual payments please. Can we have the room from 7pm for setup?",
      ...
      },
      {
        ...
        sender: "venue",
        senderName: "256 Wilmslow Road",
        message: "7pm setup is fine. See you on the 14th!",
    ...
    messages: [
      {
        ...
        sender: "you",
        senderName: "You",
        message: "Hello, we are the UoM American Studies Society and we'd like to enquire about booking your ballroom for our Spring Ball on March 14. We're expecting around 200 guests for a formal dinner and DJ. Could you send us your events package and pricing?",
        sentAt: "2026-01-10T09:00:00Z",
      },
      {
        id: "m-011",
        sender: "venue",
        senderName: "Kimpton Clocktower Hotel",
        message: "Thank you for your enquiry. Our events team would be happy to discuss this with you. Our minimum spend for ballroom hire on a Saturday evening is £5,000. Could you arrange a call with our events coordinator? Available times: Mon-Fri 10am-4pm.",
      ...
      },
      {
        ...
        sender: "you",
        senderName: "You",
        message: "Thanks for sending that over. The pricing looks within our budget. Can we schedule a call for Wednesday January 22 at 2pm?",
