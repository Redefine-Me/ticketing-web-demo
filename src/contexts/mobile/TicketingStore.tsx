...
import { TicketType, TicketPurchase, TicketedEventSummary, EventWithDetails } from '@/types/mobile';
import { mockTicketTypes, mockPurchases, ticketedEventIds } from '@/lib/mobile/mock-ticket-data';
