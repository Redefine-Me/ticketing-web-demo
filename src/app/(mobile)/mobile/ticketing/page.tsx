...
import { getEventImageUrl, getSocietyName, getEventDate } from '@/lib/mobile/helpers';
import Link from 'next/link';
import { CalendarOutlineIcon, TicketIcon, QRCodeIcon } from '@/components/mobile/icons';
      ...
      <div className="space-y-3">
        {attendingEvents.map(event => {
          ...
          return (
            <Link
              key={event.id}
              href={`/mobile/ticketing/${event.id}`}
