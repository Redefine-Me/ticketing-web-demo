...
import { getEventImageUrl, getSocietyName, getEventDate, getEventLocation } from '@/lib/mobile/helpers';
import { ArrowLeftIcon, CalendarOutlineIcon, LocationOutlineIcon } from '@/components/mobile/icons';
  ...
  if (!event) {
    return (
      <div className="flex flex-col items-center justify-center py-20 px-4">
        ...
        <button
          onClick={() => router.push('/mobile/ticketing')}
