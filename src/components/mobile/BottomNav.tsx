...
import { HomeIcon, TicketIcon, ClipboardListIcon } from '@/components/mobile/icons';

const tabs = [
  { href: '/mobile', label: 'Home', Icon: HomeIcon },
  { href: '/mobile/ticketing', label: 'Tickets', Icon: TicketIcon },
  { href: '/mobile/manage', label: 'Manage', Icon: ClipboardListIcon },
];
