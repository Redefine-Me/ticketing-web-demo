...
import { EventWithDetails, TicketType, TicketedEventSummary } from '@/types/mobile';
import { getEventImageUrl } from '@/lib/mobile/helpers';
import { PlusIcon, TrashIcon } from '@/components/mobile/icons';
import { ticketNameSuggestions } from '@/lib/mobile/mock-ticket-data';
